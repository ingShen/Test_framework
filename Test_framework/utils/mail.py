'''
    ...
    1.初始化传入全部所需数据，message是正文，可不填，path可以传list或str；receiver支持多人，用‘；隔开
'''
import re
import smtplib
    ...
    def send(self):
        ...
        try:
            ...
            try:
                ...
                logger.info('发送邮件"{0}"成功！收件人:{1}。如果没有收到邮件，请检查垃圾箱，''同时检查收件人地址是否正确'.format(self.title, self.receiver))